...
class TestGetGenResultBB(unittest.TestCase):
    """历史记录-查询基因编辑距离对比计算结果 BB端"""

    @classmethod
    def setUpClass(cls):
        Log.info('TestGetGenResultBB START BB端')
        cls.node = 2
        cls.dh = DataHandle()
        # 布里端
    ...
    def tearDownClass(cls):
        Log.info('TestGetGenResultBB END BB端')
