...
class TestComputeVcfBB(unittest.TestCase):
    """vcf协同计算-BB端"""

    @classmethod
    def setUpClass(cls):
        Log.info('TestComputeVcfBB START BB端')
        cls.node = 2
        # 计算类型  vcf;1
        cls.calType = 1
        cls.dh = DataHandle()
    ...
    def test_compute_vcf_taskId_wrong_2_fail(self):
        """BB vcf协同计算，taskid为基因协同计算的任务，失败"""
    ...
    def tearDownClass(cls):
        Log.info('TestComputeVcfBB END BB端')
